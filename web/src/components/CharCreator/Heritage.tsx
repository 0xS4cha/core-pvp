...
const HeritageComponent: React.FC<HeritageProps> = ({
  ...
  const buttonChoice = [
    { type: "dad", label: translation["parents"]["dad"], logo: "../assets/images/CharCreator/buttons/dad.svg" },
    { type: "mom", label: translation["parents"]["mom"], logo: "../assets/images/CharCreator/buttons/mom.svg" },
  ]
