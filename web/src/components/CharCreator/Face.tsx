  ...
  return (
    <div className="face__component">
      <ButtonChoice
        ...
        buttonChoice={[
          { type: "nose", label: translation["face"]["nose"], logo: "../assets/images/CharCreator/buttons/nose.svg" },
          { type: "chin", label: translation["face"]["chin"], logo: "../assets/images/CharCreator/buttons/chin.svg" },
          { type: "jaw", label: translation["face"]["jaw"], logo: "../assets/images/CharCreator/buttons/jaw.svg" },
          {
            type: "cheeks",
            label: translation["face"]["cheeks"],
            logo: "../assets/images/CharCreator/buttons/cheeks.svg",
          },
          {
            type: "eyes",
            label: translation["face"]["eyes"],
            logo: "../assets/images/CharCreator/buttons/eyes.svg",
            iconsSize: 50,
          },
        ]}
