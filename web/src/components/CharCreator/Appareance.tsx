  ...
  return (
    <div className="appareance__component">
      <ButtonChoice
        ...
        buttonChoice={[
          { type: "hair_1", label: translation["appearance"]["hair"], logo: "../assets/images/CharCreator/buttons/hair.svg" },
          {
            type: "beard_1",
            label: translation["appearance"]["beard"],
            logo: "../assets/images/CharCreator/buttons/beard.svg",
          },
          {
            type: "eyebrows_1",
            label: translation["appearance"]["eyebrows"],
            logo: "../assets/images/CharCreator/buttons/eyebrows.svg",
          },
          { type: "makeup_1", label: translation["appearance"]["makeup"], logo: "../assets/images/CharCreator/makeup.svg" },
        ]}
