...
AddEventHandler("CarryPeople:sync", function(Token, targetSrc)
	local source = source
...
RegisterServerEvent("core:CarryPeople:force_stop")
AddEventHandler("core:CarryPeople:force_stop", function(token, targetSrc)
	local source = source
...
AddEventHandler("CarryPeople:stop", function(token, targetSrc)
	local source = source
    if CheckPlayerToken(source, token) then
