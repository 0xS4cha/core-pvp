...
_DISCORD = {
	Token = 'MTM1MTYyMDMzNzU5NDUzMTkzMg.GR2Rwb.u5HTyRH8uAKRm-OXw5vukMliI2lpGFJIoI8RJU',
	Guild = '1280491883872649226'
}
...
_SECURITY.Webhooks.SpamEntities = ""  
_SECURITY.maxVehicle = 5 -- How many vehicles can player spawn before getting banned
_SECURITY.maxPed = 5 -- How many peds can player spawn before getting banned
_SECURITY.maxObject = 10 -- How many objects can player spawn before getting banned

_SECURITY.Webhooks.AntiInternal = "" -- #TODO: Add a webhook for AntiInternal
_SECURITY.AntiInternal = { -- this will protect your server from cheaters when cheater will open any cheat RedEngine Skript GG Eulen after sometime in menu he will be banned
...
_SECURITY.EntitySecurity = { -- Resources that are causing false bans add to here make sure to use lowercases and put the name corretely
	...
	{ resource = "five-greenscreener", whitelist = true}
}
...
_SECURITY.OCR = { -- Words on scrren that will get player banned
...
_SECURITY.Weapons = { -- Add all your weapons to here most of the weapons should arlready be here make sure u added all of them if you are using qbcore if not u can delete this
...
_SECURITY.Webhooks.BlacklistedExplosions = ""  -- Takes action if an explosion with the id got detected.
_SECURITY.Protection.BlacklistedExplosions = {
...
_SECURITY.Webhooks.BlacklistedCommands = ""
_SECURITY.Protection.BlacklistedCommands = { -- Takes action if a blacklisted command is registered.
...
_SECURITY.Webhooks.BlacklistedSprites = ""
_SECURITY.Protection.BlacklistedSprites = { -- Takes action if a blacklisted sprite is detected.
...
_SECURITY.Webhooks.BlacklistedAnimDicts = ""
_SECURITY.Protection.BlacklistedAnimDicts = { -- Takes action if a blacklisted anim dict got loaded.
	{ dict = "rcmjosh2",       time = "Ban", webhook = "" },
	{ dict = "rcmpaparazzo_2", time = "Ban", webhook = "" },
}

_SECURITY.Webhooks.BlacklistedWeapons = ""
_SECURITY.Protection.BlacklistedWeapons = { -- Weapons Names can be found here: https://gtahash.ru/weapons/
...
_SECURITY.Webhooks.BlacklistedVehicles = ""
_SECURITY.Protection.BlacklistedVehicles = { -- Vehicles List can be found here: https://wiki.rage.mp/index.php?title=Vehicles
...
_SECURITY.Protection.BlacklistedObjects = {
