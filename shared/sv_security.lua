...
_SECURITY.MaxSpeedDetection = 300.0
_SECURITY.BlacklistedCommands = {
    ["killmenu"] = true,
    ["menu"] = true,
    ["chocolate"] = true,
    ["lol"] = true,
...
_SECURITY.BlacklistedNames = { -- forbidden words or chars (lowercase letters)
    "%^1",
    "%^2",
    "%^3",
    "%^4",
