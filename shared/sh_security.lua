...
_ANTICHEAT.MODULE = {}
function _ANTICHEAT.MODULE.LPH_JIT_MAX(func)
    return function(...)
        return func(...)
    end
end
function _ANTICHEAT.MODULE.LPH_NO_VIRTUALIZE(func)
    return function(...)
        return func(...)
    end
end
...
local createEntity = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(originalFunction, ...)
...
CreateObject = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(...) return createEntity(_CreateObject, ...) end)
CreateObjectNoOffset = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(...) return createEntity(_CreateObjectNoOffset, ...) end)
CreateVehicle = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(...) return createEntity(_CreateVehicle, ...) end)
CreatePed = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(...) return createEntity(_CreatePed, ...) end)
CreatePedInsideVehicle = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(...) return createEntity(_CreatePedInsideVehicle, ...) end)
CreateRandomPed = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(...) return createEntity(_CreateRandomPed, ...) end)
CreateRandomPedAsDriver = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(...) return createEntity(_CreateRandomPedAsDriver, ...) end)
CreateScriptVehicleGenerator = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(...) return createEntity(_CreateScriptVehicleGenerator, ...) end)
CreateVehicleServerSetter = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(...) return createEntity(_CreateVehicleServerSetter, ...) end)
...
if IsDuplicityVersion() then
	...
	RegisterNetEvent = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(event_name, ...)
	...
	AddEventHandler = _ANTICHEAT.MODULE.LPH_JIT_MAX(function(event_name, handler)
        local encrypted_event_name = encryptEventName(event_name, encryption_key)
