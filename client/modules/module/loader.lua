...
RegisterFontFile('sunflower-bold')
Sunflowerbold = RegisterFontId('sunflower-bold')

RegisterFontFile('sunflower-medium')
Sunflowermedium = RegisterFontId('sunflower-medium')

RegisterFontFile('sunflower-light')
Sunflowerlight = RegisterFontId('sunflower-light')

RegisterFontFile('segment')
Segment = RegisterFontId('segment')

RegisterFontFile('platefont')
Platefont = RegisterFontId('platefont')
